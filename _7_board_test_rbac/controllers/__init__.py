...
from .authz_controller import authz_bp
...
all_blueprints = (page_bp, auth_bp, authz_bp, post_bp, security_bp, public_bp)

__all__ = ['all_blueprints', 'page_bp', 'auth_bp', 'authz_bp', 'post_bp',
